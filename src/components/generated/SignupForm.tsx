...
const SignupForm: React.FC<SignupFormProps> = ({
  ...
  return <div className="text-center space-y-8 md:space-y-12" data-magicpath-id="0" data-magicpath-path="SignupForm.tsx">
      <div className="space-y-4 md:space-y-6" data-magicpath-id="1" data-magicpath-path="SignupForm.tsx">
        ...
        duration: 0.5
      }} className="w-12 h-12 md:w-16 md:h-16 mx-auto rounded-full flex items-center justify-center" data-magicpath-id="2" data-magicpath-path="SignupForm.tsx">
          <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="48" height="48" viewBox="0 0 375 374.999991" preserveAspectRatio="xMidYMid meet" version="1.2" data-magicpath-id="3" data-magicpath-path="SignupForm.tsx">
