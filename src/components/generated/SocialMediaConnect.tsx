...
const XIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 48 48" data-magicpath-id="11" data-magicpath-path="SocialMediaConnect.tsx">
    ...
    <path fill="none" stroke="#18193f" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M40.5,31.5v5	c0,2.209-1.791,4-4,4h-25c-2.209,0-4-1.791-4-4V26" data-magicpath-id="13" data-magicpath-path="SocialMediaConnect.tsx"></path>
    <path fill="none" stroke="#18193f" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M7.5,18.064V11.5	c0-2.209,1.791-4,4-4h25c2.209,0,4,1.791,4,4v11.33" data-magicpath-id="14" data-magicpath-path="SocialMediaConnect.tsx"></path>
    ...
    <polygon fill="#18193f" points="24.45,21.721 25.355,23.01 33.136,14 31.136,14" data-magicpath-id="17" data-magicpath-path="SocialMediaConnect.tsx"></polygon>
  </svg>;
...
const SocialMediaConnect: React.FC = () => {
  const [platforms, setPlatforms] = useState<SocialPlatform[]>([{
    ...
    loading: false,
    icon: FacebookIcon,
    mpid: "1acfc23c-1321-4d11-a070-6a642ab2614f"
  }, {
    id: 'instagram',
    name: 'Instagram',
    connected: false,
    loading: false,
    icon: InstagramIcon,
    mpid: "16cbf790-57c3-4c47-a5ff-a8c6d872b170"
  }, {
    id: 'twitter',
    name: 'X',
    connected: false,
    loading: false,
    icon: XIcon,
    mpid: "dc1e2859-5a4b-4df1-a991-6cd9b05ba36f"
  }, {
    id: 'linkedin',
    name: 'LinkedIn',
    connected: false,
    loading: false,
    icon: LinkedInIcon,
    mpid: "700031cc-827c-4004-9153-989d3c41a4f4"
  }, {
    id: 'youtube',
    name: 'YouTube',
    connected: false,
    loading: false,
    icon: YouTubeIcon,
    mpid: "0b31dc07-b4c7-4ac8-b1a5-1aaaa351c897"
  }, {
    id: 'tiktok',
    name: 'TikTok',
    connected: false,
    loading: false,
    icon: TikTokIcon,
    mpid: "81fe7892-5d00-4ef6-94f2-94f0e79b7980"
  }]);
