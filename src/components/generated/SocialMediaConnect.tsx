...
const SocialMediaConnect: React.FC = () => {
  const [platforms, setPlatforms] = useState<SocialPlatform[]>([{
    ...
    loading: false,
    icon: FacebookIcon,
    mpid: "aca592bb-e882-48a7-9b61-dec7f06a720a"
  }, {
    id: 'instagram',
    name: 'Instagram',
    connected: false,
    loading: false,
    icon: InstagramIcon,
    mpid: "6795c3ce-2a9e-4b39-b209-3afc47dab663"
  }, {
    id: 'twitter',
    name: 'X',
    connected: false,
    loading: false,
    icon: XIcon,
    mpid: "2977f0a0-58fd-4124-b68f-2a1f80b1e991"
  }, {
    id: 'linkedin',
    name: 'LinkedIn',
    connected: false,
    loading: false,
    icon: LinkedInIcon,
    mpid: "1b00a503-9bbd-4e35-87a2-3ca8e57615d8"
  }, {
    id: 'youtube',
    name: 'YouTube',
    connected: false,
    loading: false,
    icon: YouTubeIcon,
    mpid: "3b8999b0-c8bf-4139-a2c5-b8802bb8edfe"
  }, {
    id: 'tiktok',
    name: 'TikTok',
    connected: false,
    loading: false,
    icon: TikTokIcon,
    mpid: "043d61cb-8ce8-4782-94bc-1ea33ba125ee"
  }]);
